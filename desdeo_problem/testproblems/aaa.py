...
"""test_real_example21https://arxiv.org/pdf/2009.12867.pdf, https://github.com/ryojitanabe/reproblems"""
import numpy as np
...
#The rest of the problem didn't exist in desdeo problem 
class RE34():
    def __init__(self):
...
class RE41():
    ...
    def evaluate(self, x):
        ...
        f[2] = 0.5 * (Vmbp + Vfd)
        f2 = 0.5 * ( (10.58 - 0.674 * x1 * x2 - 0.67275 * x2) + (16.45 - 0.489 * x3 * x7 - 0.843 * x5 * x6))  
        # Constraint functions
        ...
        f3 = ( 1 -(1.16 - 0.3717 * x2 * x4 - 0.0092928 * x3) ) + \
             (0.32 -(0.261 - 0.0159 * x1 * x2 - 0.06486 * x1 -  0.019 * x2 * x7 + 0.0144 * x3 * x5 + 0.0154464 * x6)) + \
             0.32 -(0.214 + 0.00817 * x5 - 0.045195 * x1 - 0.0135168 * x1 + 0.03099 * x2 * x6 - 0.018 * x2 * x7  + 0.007176 * x3 + 0.023232 * x3 - 0.00364 * x5 * x6 - 0.018 * x2 * x2) +\
             ...
             4 - (4.72 - 0.5 * x4 - 0.19 * x2 * x3) +\
             9.9 - (10.58 - 0.674 * x1 * x2 - 0.67275 * x2) +\
             15.7 - (16.45 - 0.489 * x3 * x7 - 0.843 * x5 * x6)
        ( 1 -(1.16 - 0.3717 * x2 * x4 - 0.0092928 * x3) )+ (0.32 -(0.261 - 0.0159 * x1 * x2 - 0.06486 * x1 -  0.019 * x2 * x7 + 0.0144 * x3 * x5 + 0.0154464 * x6)) + 0.32 -(0.214 + 0.00817 * x5 - 0.045195 * x1 - 0.0135168 * x1 + 0.03099 * x2 * x6 - 0.018 * x2 * x7  + 0.007176 * x3 + 0.023232 * x3 - 0.00364 * x5 * x6 - 0.018 * x2 * x2) +0.32 -(0.74 - 0.61 * x2 - 0.031296 * x3 - 0.031872 * x7 + 0.227 * x2 * x2) +32 -(28.98 + 3.818 * x3 - 4.2 * x1 * x2 + 1.27296 * x6 - 2.68065 * x7) +32 -(33.86 + 2.95 * x3 - 5.057 * x1 * x2 - 3.795 * x2 - 3.4431 * x7 + 1.45728) +32 -(46.36 - 9.9 * x2 - 4.4505 * x1) + 4 - (4.72 - 0.5 * x4 - 0.19 * x2 * x3) +9.9 - (10.58 - 0.674 * x1 * x2 - 0.67275 * x2) +15.7 - (16.45 - 0.489 * x3 * x7 - 0.843 * x5 * x6)
        return f
...
class RE42():
    ...
    def evaluate(self, x):
        ...
        gg = ((0.53 * x_T) + (((0.085 * x_CB - 0.002) * x_B * x_B) / (x_T * x_CB)) - (1.0 + 0.52 * x_D)) - (0.07 * x_B)
